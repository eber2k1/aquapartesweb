...
const InstallPWA = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-4 bg-sky-600 hover:bg-sky-700 text-white px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 transition-colors duration-200 z-50"
